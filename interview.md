...
2.  ### What are the major features of React? - Reactning asosiy xususiyatlari qanday?
    ...
    - **Bir yo'nalishli ma'lumotlar oqimi**ni yoki **ma'lumotlarni bog'lash**ni kuzatib boradi.
...
4.  ### What is the difference between Element and Component?
    ...
    const element = React.createElement(
      "div", // tag
      { id: "login-btn" }, // props-attribut
      "Login" // props-children
      );
    ```

    Yuqoridagi `React.createElement()` funksiyasi quidagi obyektni qaytaradi:
    ...
    Va nihoyat, u obyekt ReactDOM.render() funksiyasi yordamida DOM-ga render qilinadi:
